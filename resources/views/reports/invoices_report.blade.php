                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                                <p class="mg-b-10">تحديد نوع الفواتير</p><select class="form-control select2" name="type"
                                                                                 {{--select2 للبحث فالاوبشن--}}
                                                                                 required>
{{-- عشان الفي الاوبشن دا لازم الغي انه يعمل ريفرش للصفحه لما ابعت حاجه لو عملت كدا تعالي شيل اول اوبشن دا   --}}
                                    <option value="{{ $type ?? 'حدد نوع الفواتير' }}" selected hidden disabled>
                                        {{ $type ?? 'حدد نوع الفواتير' }}
                          {{--   لو في type حددهولي لو مفيش اكتبلي حدد نوع الفاتوره--}}
                                    </option>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#invoice_number').hide();  // بخفي البحث برقم الفاتوره الاول ولما اليوزر يختار هيبحث ب اي سواء
            // ب رقم الفاتوره او بنوع الفاتوره علي اساسه اظهرله بقا
