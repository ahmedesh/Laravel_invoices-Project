...
{{-- title --}}
@section('title')
    <title> قائمة الفواتير الغير المدفوعه </title>
@endsection
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة الفواتير الغير المدفوعه </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
