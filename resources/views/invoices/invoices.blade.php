    ...
    <div class="card mg-b-20">
        <div class="card-header pb-0">
                ...
                <a href="invoices/create" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                        ...
                        @endcan
            @can('تصدير EXCEL')   {{-- to export excel  --}}
                <a class="modal-effect btn btn-sm btn-primary" href="{{ url('export_invoices') }}"  {{-- export_invoices => دا اسم الروت --}}
                                        ...
                                        <a class="dropdown-item" href="#" data-invoice_id="{{ $inovice->id }}"
                                           data-toggle="modal" data-target="#Transfer_invoice"><i
                                            ...
                                            الارشيف</a>
                                                ...
                                                @can('طباعةالفاتورة')
                            <a class="dropdown-item" href="Print_invoice/{{ $inovice->id }}"><i  {{-- Print_invoice=> دا اسم الروت بتاعه --}}
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        {{-- لو حصل ايررور وديني علي صفحه test --}}
                        {{ method_field('delete') }}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="invoice_id" id="invoice_id" value="">
                <input type="hidden" name="id_page" id="id_page" value="2">{{-- عامل الحقل دا عشان اباصيه للكونترولر ولو هو يعمل ارشفه مش هو يعمل حذف --}}
