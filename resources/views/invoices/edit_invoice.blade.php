...
{{--                        action="{{ url('invoices/update') }}"  عملته هنا url عشان هو فال route المفروض بيرجعله id --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_Date" placeholder="YYYY-MM-DD"
                                       type="date" value="{{$invoices->invoice_Date}}" required>
                            </div>

                            <div class="col">
                                <label>تاريخ الاستحقاق</label>
                                <input class="form-control fc-datepicker" name="Due_date" placeholder="YYYY-MM-DD"
                                       type="date" value="{{$invoices->Due_date}}" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="Section" class="form-control  nice-select  custom-select" onclick="console.log($(this).val())"
                                        onchange="console.log('change is firing')" required>
                                    <!--placeholder-->
                                    <option  style="color: #9999" value=" {{ $invoices->sction->id }}"> {{$invoices->sction->section_name}} </option>
                                    @foreach ($sections as $section)--}}
                                        <option value="{{ $section->id }}"@if($section->id == $invoices->sction->section_id) selected @endif>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control nice-select  custom-select" onchange="myFunction()"
                                        value="{{$invoices->Rate_VAT}}" required>
                                    <!--placeholder-->
                                    <option style="color:#9999;" value="{{$invoices->Rate_VAT}}">{{$invoices->Rate_VAT}}</option>
