								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
                                            ...
                                            <a href="\MarkAsRead_all"> نعيين قراءه الكل </a> </span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12" style="color: yellow"
                                           id="notifications_count"> {{-- id="notifications_count"=> عشان اخليه يعمل ريفرش عليه بال ajax تلقائي --}}
               {{--      كتبت الكود الajax اللي يخليه يعمل ريفرش ف صفحه master.blade.php عشان هو بستدعيه ف كل الصفحات الملف دا   --}}
                                            {{ auth()->user()->unreadNotifications->count() }}
                                        </p>
									</div>
                                    <div id="unreadNotifications"> {{-- id="unreadNotifications"=> عشان اخليه يعمل ريفرش عليه بال ajax تلقائي --}}
               {{--      كتبت الكود الajax اللي يخليه يعمل ريفرش ف صفحه master.blade.php عشان هو بستدعيه ف كل الصفحات الملف دا   --}}
