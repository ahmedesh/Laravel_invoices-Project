...
{{--					<li class="side-item side-item-category"> برنامج الفواتير </li>--}}
                    ...
                    @can('الفواتير')  {{-- الفواتير== دا صلاحيه موجوده فال premission لو انا ادتهالو هيظهرها مش اديتهاله مش هيظهرها --}}
{{--					<li class="side-item side-item-category"> الفواتير </li>--}}
					...
					<li class="slide p-2">
						...
						<ul class="slide-menu list-item-none">
                            {{-- $page => بكتب جواها ال Route --}}
                            @can('قائمة الفواتير')  {{-- قائمة الفواتير=> دي موجوده فال PermissionTableSeeder وهكذا بقا --}}
							<li><a class="slide-item" href="{{ url('/' . $page='invoices') }}"> قائمة الفواتير </a></li>
                            @endcan
                                @can('الفواتير المدفوعة')  {{-- Invoice_Paid => دا ال Route --}}
							<li><a class="slide-item" href="{{ url('/' . $page='Invoice_Paid') }}">الفواتير المدفوعة</a></li>
                            @endcan
                                    @can('الفواتير الغير مدفوعة') {{-- Invoice_UnPaid => دا ال Route --}}
...
{{--					<li class="side-item side-item-category">المستخدمين</li>--}}
					<li class="slide p-2">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='users') }}">قائمة المسنخدمين</a></li>
                            @endcan
                                @can('صلاحيات المستخدمين')
							<li><a class="slide-item" href="{{ url('/' . $page='roles') }}">صلاحيات المسنخدمين</a></li>
                            @endcan
						</ul>
					</li>
                    @endcan
